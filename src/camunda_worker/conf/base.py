...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("DB_NAME", "camunda_worker"),
        "USER": os.getenv("DB_USER", "camunda_worker"),
        "PASSWORD": os.getenv("DB_PASSWORD", "camunda_worker"),
...
ROOT_URLCONF = "camunda_worker.urls"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "camunda_worker.utils.context_processors.settings",
...
WSGI_APPLICATION = "camunda_worker.wsgi.application"
...
DEFAULT_FROM_EMAIL = "camunda_worker@example.com"
EMAIL_TIMEOUT = 10
...
LOGGING = {
    ...
    "handlers": {
        ...
        "project": {
            "level": "DEBUG",
            "class": "logging.handlers.RotatingFileHandler",
            "filename": os.path.join(LOGGING_DIR, "camunda_worker.log"),
            "formatter": "verbose",
            "maxBytes": 1024 * 1024 * 10,  # 10 MB
            "backupCount": 10,
        },
...
AUTHENTICATION_BACKENDS = [
    ...
    "camunda_worker.accounts.backends.UserModelEmailBackend",
